...
@section('page-name', 'Data Barang Keluar')
@section('content')
                        ...
                        <div class="app-card-body">
                            <div class="table-responsive">
                                <table id="dataTable2" class="table table-bordered">
                                    ...
                                    <tbody>
                                        @php
                                            $no = $barangkeluar->firstItem(); // Nomor indeks dimulai dari halaman saat ini
                                        @endphp
                        ...
                        <div class="col-auto ms-auto">
                            ...
                            <nav class="app-pagination">
                                <ul class="pagination justify-content-center">
                                    ...
                                    @else
                                        <li class="page-item">
                                            <a class="page-link" href="{{ $barangkeluar->previousPageUrl() }}"
                                                aria-label="Previous">&laquo;</a>
                                        </li>
                                    @endif

                                    <!-- Tombol Halaman -->
                                    @for ($i = 1; $i <= $barangkeluar->lastPage(); $i++)
                                        <li class="page-item {{ $i == $barangkeluar->currentPage() ? 'active' : '' }}">
                                            <a class="page-link"
                                                href="{{ $barangkeluar->url($i) }}">{{ $i }}</a>
                                        </li>
                                    @endfor
                                    ...
                                    @if ($barangkeluar->hasMorePages())
                                        <li class="page-item">
                                            <a class="page-link" href="{{ $barangkeluar->nextPageUrl() }}"
