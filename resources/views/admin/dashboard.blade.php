                ...
                <div class="app-card-body p-3 p-lg-4">
                    ...
                    <div class="row gx-5 gy-3">
                        <div class="col-12 col-lg-9">
                            ...
                            <div>Ini adalah Admin Panel dari E-Commerce TyyStore. Mohon teliti dalam pendataan produk agar tidak terjadi
                                kesalahan dalam Aplikasi E-Commerce TyyStore.
                            </div>
                        </div><!--//col-->
                    </div><!--//row-->
