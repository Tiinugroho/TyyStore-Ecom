                ...
                <div class="col-auto">
                    <div class="page-utilities">
                        <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
                            ...
                            <div class="col-auto">
                                <a href="{{ url('admin/slider/create') }}" class="btn app-btn-secondary">
                                ...
                                <table id="dataTable" class="table table-bordered table-responsive">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="cell"><span class="truncate"><img class="img-thumbnail" src="{{ asset('slider/' . $value->foto) }}"
                                                    alt="image"></span></td>
                                            <td class="cell"><span class="truncate">{{ $value->pajang }}</span></td>
                                            <td class="cell"><span class="truncate">{{ $value->tglmasuk }}</span></td>
                                            <td class="cell">
                                                <a href="{{ url('admin/slider/' . $value->id) }}"
                                                    class="btn btn-success btn-sm text-white">
                                                    Edit
                                                </a><br><br>
                                                <form action="{{ url('admin/slider', $value->id) }}" method="post">
                                                    @csrf
