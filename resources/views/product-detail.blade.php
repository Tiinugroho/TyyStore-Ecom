                            ...
                            <div class="product-gallery product-gallery-vertical">
                                <div class="row">
                                    ...
                                    $produk = DB::table('tbstok')
                                        ...
                                        ->select('tbstok.*', 'tbkategori.nama as namakategori')
                                        ->where('tbstok.id', $id)
                                        ->orderBy('tbstok.id', 'DESC')
                                        ->first();
                                    ?>
                                    <figure class="product-main-image">
                                        <img id="product-zoom" src="{{ asset('image/' . $produk->cover) }}" data-zoom-image="assets/images/products/single/1-big.jpg" alt="product image">
                                    ...
                                    <div id="product-zoom-gallery" class="product-image-gallery">
                                        @foreach (json_decode($produk->foto) as $photo)
                                            <a class="product-gallery-item" href="#"
                                                data-image="{{ asset('image/' . $photo) }}"
                                                data-zoom-image="{{ asset('image/' . $photo) }}">
                                                <img src="{{ asset('image/' . $photo) }}" alt="product side">
                                            </a>
                                        @endforeach
                        ...
                        <div class="col-md-6">
                            <div class="product-details">
                                ...
                                <div class="ratings-container">
                                    ...
                                    <a class="ratings-text" href="#product-review-link" id="review-link">( Stok : {{ $produk->saldoakhir }} )</a>
                                ...
                                <div class="details-filter-row details-row-size">
                                    <div class="product-details-quantity">
                                        @if (Auth::check())
                                        <form action="{{ route('product-detail.store') }}" method="post" id="product-form">
                                            @csrf
                                            <label for="jumlah_pesan" class="text-black-50">Jumlah:</label>
                                            <div class="details-filter-row details-row-size">
                                                <div class="product-details-quantity">
                                                    <input type="hidden" name="id_barang" value="{{ $produk->id }}">
                                                    <input type="number" id="jumlah_pesan" name="jumlah_pesan" class="form-control" value="1" min="1" max="10" step="1" required>
                                                    <br>
                                                    <button type="submit" class="btn btn-outline-success" id="add-to-cart-btn">
                                                        <i class="icon-cart-plus"></i><span>Tambah Ke Cart</span>
                                                    </button>
                                        ...
                                        @else
                                            <button type="button" class="btn btn-outline-success" onclick="alert('Anda harus login terlebih dahulu untuk menambahkan produk ke keranjang.'); window.location.href = '{{ route('login') }}';">
                                                <i class="icon-cart-plus"></i><span>Tambah Ke Cart</span>
                                            </button>
                                        @endif
                                    </div><!-- End .product-details-quantity -->
            ...
            <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl"
                ...
                <div class="product product-7 text-center">
                    <figure class="product-media">
                        ...
                        <a href="product.html">
                            <img src="{{ url('client/assets/images/products/product-4.jpg') }}" alt="Product image"
                                class="product-image">
                        </a>
                        ...
                        <div class="product-action-vertical">
                            <a href="#" class="btn-product-icon btn-wishlist btn-expandable"><span>add to
                                    wishlist</span></a>
                            <a href="/quickView" class="btn-product-icon btn-quickview" title="Quick view"><span>Quick
                                    view</span></a>
                    ...
                    <div class="product-body">
                        ...
                        <div class="product-nav product-nav-thumbs">
                            <a href="#" class="active">
                                <img src="{{ url('client/assets/images/products/product-4-thumb.jpg') }}"
                                    alt="product desc">
                            </a>
                            <a href="#">
                                <img src="{{ url('client/assets/images/products/product-4-2-thumb.jpg') }}"
                                    alt="product desc">
                            </a>

                            <a href="#">
                                <img src="{{ url('client/assets/images/products/product-4-3-thumb.jpg') }}"
                                    alt="product desc">
                            </a>
                        </div><!-- End .product-nav -->
                ...
                <div class="product product-7 text-center">
                    <figure class="product-media">
                        ...
                        <a href="product.html">
                            <img src="{{url('client/assets/images/products/product-6.jpg')}}" alt="Product image" class="product-image">
                        </a>
                ...
                <div class="product product-7 text-center">
                    <figure class="product-media">
                        ...
                        <a href="product.html">
                            <img src="{{url('client/assets/images/products/product-11.jpg')}}" alt="Product image" class="product-image">
                        </a>
                    ...
                    <div class="product-body">
                        ...
                        <div class="product-nav product-nav-thumbs">
                            <a href="#" class="active">
                                <img src="{{url('client/assets/images/products/product-11-thumb.jpg')}}" alt="product desc">
                            </a>
                            <a href="#">
                                <img src="{{url('client/assets/images/products/product-11-2-thumb.jpg')}}" alt="product desc">
                            </a>

                            <a href="#">
                                <img src="{{url('client/assets/images/products/product-11-3-thumb.jpg')}}" alt="product desc">
                            </a>
                        </div><!-- End .product-nav -->
                    </div><!-- End .product-body -->
                </div><!-- End .product -->
                ...
                <div class="product product-7 text-center">
                    <figure class="product-media">
                        <a href="product.html">
                            <img src="{{url('client/assets/images/products/product-10.jpg')}}" alt="Product image" class="product-image">
                        </a>
                ...
                <div class="product product-7 text-center">
                    <figure class="product-media">
                        <a href="product.html">
                            <img src="{{url('client/assets/images/products/product-7.jpg')}}" alt="Product image" class="product-image">
                        </a>
